        ...
        <form id="form" method="post" onsubmit="return validateForm()" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            <table>
                <tr>
                    ...
                    <td>
                        <input type="password" id="myInput" name="cPassword" value=<?php echo $cPassword ?>>
                ...
                <tr>
                    ...
                    <td>
                        <input type="password" id="myInput" name="nPassword" value=<?php echo $nPassword ?>>
                ...
                <tr>
                    ...
                    <td>
                        <input type="password" id="myInput" name="rPassword" value=<?php echo $rPassword ?>>
            ...
            <br>
            <input type="submit" class="button2Reg buttonReg" name="submit" value="Submit">
        </form>
    </dev>
</body>
